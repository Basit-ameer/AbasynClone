    ...
    a = function() {
        ...
        e.logImpression = function(a, e, f) {
            ...
            if (c("gkx")("876709")) try {
                ...
                e = i.page_id;
                j = i.top_level_post_id;
                a = i.fbfeed_location;
                e && j && d("ViewableSessionStore").onEventLogged("page_post_impression", j, a)
            } catch (a) {
...
__d("ViewableImpressionTracking", ["Arbiter", "DesktopHscrollUnitEventConstants", "ErrorUtils", "LitestandMessages", "Run", "ViewableImpressionConfig", "ViewableImpressionEventHandler"], (function(a, b, c, d, e, f, g) {
    function a() {
        c("ViewableImpressionEventHandler").instance === void 0 && (c("ViewableImpressionEventHandler").instance = new(c("ViewableImpressionEventHandler"))(c("ViewableImpressionConfig")), c("ViewableImpressionEventHandler").instance.listeners != null && c("ViewableImpressionEventHandler").instance.listeners.addSubscriptions(c("Arbiter").subscribe([c("LitestandMessages").STORIES_INSERTED, "AdsRefreshHandler/AdsLoaded", "MPPInsights/ChartView", "PhotoSnowliftAds/displayUnits", "WebMessengerAdsControl/adjustAds", d("DesktopHscrollUnitEventConstants").HSCROLL_ITEM_INSERTED_EVENT, "WebVideoChannelAds/AdsLoaded", "Stories/cardChanged"], c("ErrorUtils").guard(function(a) {
