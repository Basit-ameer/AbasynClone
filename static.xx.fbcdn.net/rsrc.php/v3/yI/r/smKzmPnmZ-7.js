    ...
    a = function() {
        ...
        d.patchRequestHeaders = function(a) {
            ...
            if (!c("isEmpty")(c("WebDriverConfig").auxiliaryServiceInfo)) {
                ...
                f != null ? (typeof f.ip_address === "string" ? d[i] = f.ip_address + ":18295" : typeof f.hostname === "string" && (d[i] = f.hostname + ":18295"), typeof c("WebDriverConfig").originHost === "string" && (d[j] = "www." + c("WebDriverConfig").originHost)) : e != null && (d[h] = e)
            } else e != null && (d[h] = e);
...
__d("MqttConnection", ["MqttConnectionHookCollection", "MqttEnv", "MqttProtocolClient", "MqttPublishListener", "MqttTypes", "MqttUserName", "MqttUtils", "Promise", "err", "qex"], (function(a, b, c, d, e, f, g) {
    ...
    a = function() {
        ...
        e.publish = function(a, e, f, g) {
            ...
            !j ? (g == null ? void 0 : g.onEvent(d("MqttPublishListener").MqttPublishEvent.NOT_CONNECTED), h.reject(c("err")("Client disconnected"))) : this.$32(a, e, f, h);
            return i
        };
        ...
        e.$29 = function(a) {
            this.$8 && this.$7 != null && (this.$34("Disconnected"), this.$7 != null && (this.$7.disconnect(a), this.$27.onConnectionDisconnect()), this.$7 = null)
        };
        e.$35 = function(a) {
        ...
        e.$34 = function(a) {
            a !== this.$11 && (this.$10.debugTrace("MQTTConnection-updateState", "State changed to: " + a), this.$35(a), this.$11 = a, this.$1(a))
        };
        e.$28 = function() {
            var a = this;
            if (!this.$8) return;
            ...
            try {
                ...
                this.$10.bumpCounter("js_error_in_init_exception"), this.$34("Disconnected"), this.$45(!1, !1, b, this.$18, f, [], e, null, 14, "init error - " + a.message), a && this.$10.logErrorWarn(a, "ws_js_error"), this.$27.onWSFatal(), this.$46(new(d("MqttTypes").MqttChannelError)(!1, "ws_js_error", a), "client_init")
            }
        };
        e.$36 = function() {
            var a = this.$4(),
        ...
        e.$40 = function(a, b, c, d, e, f) {
            this.$10.bumpCounter("protocol.onconnectsuccess"), this.$10.debugTrace("connect", "Connect success"), this.$6.getIsGuestAuthStringPresent() && this.$10.bumpCounter("guestAuthentication.onconnectsucess"), this.$27.onConnectSuccess(), this.$26 = !0, this.$34("Connected"), this.$45(!0, !0, a, b, c, d, e, f), this.$49(c), this.$16 = Date.now()
        };
        e.$42 = function(a, b) {
...
__d("DGWRequestStreamRef", ["CompactSerializerPolyfill", "DGWRequestStreamUtils", "DGWStream", "DGWStreamHandler", "InflightAmends", "Promise", "RTISubscriptionManagerConfig", "RequestStreamCloseReason", "RequestStreamCommonRequestStreamCommonTypes", "RequestStreamE2EClientLoggerEvent", "RequestStreamE2EClientLoggerMessageType", "RequestStreamE2ELogger", "RequestStreamE2ESampling", "RequestStreamSingleChannelSingleChannelRequestStreamSerializers", "RequestStreamSingleChannelSingleChannelRequestStreamTypes", "RequestStreamState", "RequestStreamTransport", "err", "gkx", "regeneratorRuntime"], (function(a, b, c, d, e, f, g) {
    ...
    a = function() {
        function a(a, b, e, f, g, i) {
            ...
            this.$14 = !1;
            this.$19 = i;
            g != null && (this.$21() || (g.dgwStreamGroupLoggingId = this.$19.getStreamGroupLoggingId()), g.dgwCountPriorStreamsInGroup = this.$19.guessStreamGroupPriorStreamCount(), g.transport = "WEB_RS_STARGATE");
